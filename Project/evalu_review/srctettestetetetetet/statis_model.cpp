...
#ifdef DEBUG_TEST
	d5000.d5000_ExecSingle("call evalusystem.detail.TEST_PROCESS()",&err_info);
#endif
...
int StatisModel::GetDevtpgoodByDay(ES_TIME *es_time)
{
	...
	sprintf(sql, "select organ_code,sum(value) from evalusystem.result.day_%04d%02d%02d where "
		"code='devtpgood' and dimname!='无' group by organ_code", byear, bmonth, bday);
...
int StatisModel::GetDevicesByDay(ES_TIME *es_time)
{
	...
	sprintf(sql, "select organ_code,sum(value) from evalusystem.result.day_%04d%02d%02d where "
		"code='devices' and dimname!='无' group by organ_code", byear, bmonth, bday);
...
int StatisModel::InsertResultToMonth(ES_TIME *es_time)
{
	...
	//删除月指标当日模型数据
	sprintf(sql, "delete from evalusystem.result.month_%04d%02d where statistime='%04d-%02d-%02d 00:00:00.0' "
		"and dimname!='无' and (code='topogood' or code='devtpgood' or code='devices' or code='topogood2' or "
		"code='tpdvgood' or code='tpdvtotal' or code='dmsloopnum' or code='topogood3')", 
	...
	sprintf(sql, "insert into evalusystem.result.month_%04d%02d(code,organ_code,value,datatype,updatetime,"
		...
		"code='dmsloopnum' or code='topogood3')", byear, bmonth, byear, bmonth, bday);
...
int StatisModel::ModelCheck(ES_TIME *es_time)
{
	...
	sprintf(cmd, "/home/d5000/fujian/src/bin/modelmerge/file_scan 1 %04d%02d%02d",
		byear, bmonth, bday);
