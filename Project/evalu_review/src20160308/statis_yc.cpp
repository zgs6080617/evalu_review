...
int StatisYC::GetRightJudgedNum(int statis_type, ES_TIME *es_time)
{
	...
	sprintf(sql,"delete from evalusystem.result.dmsjudged_old a where rowid!="
		"(select max(rowid) from evalusystem.result.dmsjudged_old b where a.organ_code=b.organ_code and "
		"a.count_time=b.count_time and a.gpmsid=b.gpmsid and count_time = '%04d-%02d-%02d 00:00:00.0');",
		byear,bmonth,bday);
